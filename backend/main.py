...
# from routes import auth, profile, assessment, career, resume, roadmap, skill_gap, placement, progress, chatbot, admin
...
# # ── FastAPI app ────────────────────────────────────────────────
# app = FastAPI(
#     title       = "Smart AI Career Guidance System",
#     description = "AI-Driven Career Guidance and Placement Readiness Platform",
#     version     = "2.0.0"
# )

# # ── CORS — allow React frontend (port 3000 or 5173) ───────────
# app.add_middleware(
#     CORSMiddleware,
#     allow_origins     = [
#         "http://localhost:3000",
...
# # This is the fix for 404 errors.
# # Your frontend calls /api/admin/stats, /api/assessment/submit etc.
# # Every router MUST use prefix="/api/..."
...
# def root():
#     return {
#         "message": "Smart AI Career Guidance System API is running",
...
def startup():
    ...
    print("[DOCS] ReDoc UI   -> http://localhost:8000/redoc")
