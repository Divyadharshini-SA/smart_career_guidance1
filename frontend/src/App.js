...
/**
 * AdminRoute — checks role from JWT (NOT a hardcoded password).
 * The role is set in the database and returned via /api/auth/login.
 */
    ...
    <AuthProvider>
      <BrowserRouter>
        ...
        <Routes>
          ...
          {/* /admin-login now just redirects to /login securely */}
