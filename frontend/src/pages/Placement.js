...
const hr = () => 'https://www.hackerrank.com/domains/algorithms';
const yt = (q) => `https://www.youtube.com/results?search_query=${q}`;

const DSA_PROBLEMS = [
  // ── ARRAYS (13) ──────────────────────────────────────────────
  {
    id: 1, topic: 'Arrays', difficulty: 'Easy', name: 'Two Sum',
    ...
    yt: yt('two+sum+leetcode+solution')
  },
  {
    id: 2, topic: 'Arrays', difficulty: 'Easy', name: 'Best Time to Buy and Sell Stock',
    ...
    yt: yt('best+time+buy+sell+stock+leetcode+solution')
  },
  {
    id: 3, topic: 'Arrays', difficulty: 'Medium', name: 'Maximum Subarray (Kadane)',
    ...
    yt: yt('kadane+algorithm+maximum+subarray+leetcode')
  },
  {
    id: 4, topic: 'Arrays', difficulty: 'Medium', name: 'Rotate Array',
    ...
    yt: yt('rotate+array+leetcode+solution')
  },
  {
    id: 5, topic: 'Arrays', difficulty: 'Medium', name: 'Find the Duplicate Number',
    ...
    hr: hr(),
    yt: yt('find+duplicate+number+leetcode+solution')
  },
  {
    id: 6, topic: 'Arrays', difficulty: 'Medium', name: 'Product of Array Except Self',
    lc: 'https://leetcode.com/problems/product-of-array-except-self/',
    gfg: 'https://www.geeksforgeeks.org/product-of-array-except-self/',
    hr: hr(),
    yt: yt('product+of+array+except+self+leetcode+solution')
  },
  {
    id: 7, topic: 'Arrays', difficulty: 'Medium', name: 'Container With Most Water',
    lc: 'https://leetcode.com/problems/container-with-most-water/',
    gfg: 'https://www.geeksforgeeks.org/container-with-most-water/',
    hr: hr(),
    yt: yt('container+with+most+water+leetcode+two+pointer')
  },
  {
    id: 8, topic: 'Arrays', difficulty: 'Medium', name: '3Sum',
    lc: 'https://leetcode.com/problems/3sum/',
    gfg: 'https://www.geeksforgeeks.org/find-a-triplet-that-sum-to-a-given-value/',
    hr: hr(),
    yt: yt('3sum+leetcode+solution+two+pointer')
  },
  {
    id: 9, topic: 'Arrays', difficulty: 'Medium', name: 'Merge Intervals',
    lc: 'https://leetcode.com/problems/merge-intervals/',
    gfg: 'https://www.geeksforgeeks.org/merging-intervals/',
    hr: hr(),
    yt: yt('merge+intervals+leetcode+solution')
  },
  {
    id: 10, topic: 'Arrays', difficulty: 'Medium', name: 'Set Matrix Zeroes',
    lc: 'https://leetcode.com/problems/set-matrix-zeroes/',
    gfg: 'https://www.geeksforgeeks.org/a-boolean-matrix-question/',
    hr: hr(),
    yt: yt('set+matrix+zeroes+leetcode+solution')
  },
  {
    id: 11, topic: 'Arrays', difficulty: 'Medium', name: 'Jump Game',
    lc: 'https://leetcode.com/problems/jump-game/',
    gfg: 'https://www.geeksforgeeks.org/jump-game/',
    hr: hr(),
    yt: yt('jump+game+greedy+leetcode+solution')
  },
  {
    id: 12, topic: 'Arrays', difficulty: 'Hard', name: 'Trapping Rain Water',
    lc: 'https://leetcode.com/problems/trapping-rain-water/',
    gfg: 'https://www.geeksforgeeks.org/trapping-rain-water/',
    hr: 'https://www.hackerrank.com/challenges/rain-water/problem',
    yt: yt('trapping+rain+water+leetcode+solution')
  },
  {
    id: 13, topic: 'Arrays', difficulty: 'Hard', name: 'Sliding Window Maximum',
    ...
    hr: hr(),
    yt: yt('sliding+window+maximum+deque+leetcode+solution')
  },

  // ── STRINGS (11) ─────────────────────────────────────────────
  {
    id: 14, topic: 'Strings', difficulty: 'Easy', name: 'Reverse String',
    ...
    yt: yt('reverse+string+leetcode+solution')
  },
  {
    id: 15, topic: 'Strings', difficulty: 'Easy', name: 'Valid Palindrome',
    ...
    yt: yt('valid+palindrome+leetcode+solution')
  },
  {
    id: 16, topic: 'Strings', difficulty: 'Easy', name: 'Valid Anagram',
    ...
    yt: yt('valid+anagram+leetcode+solution+hashmap')
  },
  {
    id: 17, topic: 'Strings', difficulty: 'Easy', name: 'Longest Common Prefix',
    lc: 'https://leetcode.com/problems/longest-common-prefix/',
    gfg: 'https://www.geeksforgeeks.org/longest-common-prefix-using-character-by-character-matching/',
    hr: hr(),
    yt: yt('longest+common+prefix+leetcode+solution')
  },
  {
    id: 18, topic: 'Strings', difficulty: 'Medium', name: 'Longest Substring Without Repeating',
    ...
    yt: yt('longest+substring+without+repeating+characters+sliding+window+leetcode')
  },
  {
    id: 19, topic: 'Strings', difficulty: 'Medium', name: 'Group Anagrams',
    ...
    hr: hr(),
    yt: yt('group+anagrams+leetcode+hashmap+solution')
  },
  {
    id: 20, topic: 'Strings', difficulty: 'Medium', name: 'Longest Palindromic Substring',
    lc: 'https://leetcode.com/problems/longest-palindromic-substring/',
    gfg: 'https://www.geeksforgeeks.org/longest-palindrome-substring/',
    hr: hr(),
    yt: yt('longest+palindromic+substring+expand+around+center+leetcode')
  },
  {
    id: 21, topic: 'Strings', difficulty: 'Medium', name: 'String to Integer (atoi)',
    lc: 'https://leetcode.com/problems/string-to-integer-atoi/',
    gfg: 'https://www.geeksforgeeks.org/write-your-own-atoi/',
    hr: hr(),
    yt: yt('string+to+integer+atoi+leetcode+solution')
  },
  {
    id: 22, topic: 'Strings', difficulty: 'Medium', name: 'Count and Say',
    lc: 'https://leetcode.com/problems/count-and-say/',
    gfg: 'https://www.geeksforgeeks.org/look-and-say-sequence/',
    hr: hr(),
    yt: yt('count+and+say+leetcode+solution')
  },
  {
    id: 23, topic: 'Strings', difficulty: 'Hard', name: 'Minimum Window Substring',
    ...
    hr: hr(),
    yt: yt('minimum+window+substring+sliding+window+leetcode')
  },
  {
    id: 24, topic: 'Strings', difficulty: 'Hard', name: 'Wildcard Matching',
    lc: 'https://leetcode.com/problems/wildcard-matching/',
    gfg: 'https://www.geeksforgeeks.org/wildcard-pattern-matching/',
    hr: hr(),
    yt: yt('wildcard+matching+dynamic+programming+leetcode')
  },

  // ── LINKED LIST (10) ─────────────────────────────────────────
  {
    id: 25, topic: 'Linked List', difficulty: 'Easy', name: 'Reverse Linked List',
    ...
    yt: yt('reverse+linked+list+iterative+recursive+leetcode')
  },
  {
    id: 26, topic: 'Linked List', difficulty: 'Easy', name: 'Middle of Linked List',
    ...
    yt: yt('middle+of+linked+list+two+pointer+leetcode')
  },
  {
    id: 27, topic: 'Linked List', difficulty: 'Easy', name: 'Linked List Cycle',
    ...
    yt: yt('linked+list+cycle+detection+floyd+algorithm+leetcode')
  },
  {
    id: 28, topic: 'Linked List', difficulty: 'Easy', name: 'Merge Two Sorted Lists',
    ...
    yt: yt('merge+two+sorted+linked+lists+leetcode+solution')
  },
  {
    id: 29, topic: 'Linked List', difficulty: 'Medium', name: 'Remove Nth Node From End',
    ...
    yt: yt('remove+nth+node+from+end+of+list+leetcode+two+pointer')
  },
  {
    id: 30, topic: 'Linked List', difficulty: 'Medium', name: 'Add Two Numbers',
    ...
    hr: hr(),
    yt: yt('add+two+numbers+linked+list+leetcode+solution')
  },
  {
    id: 31, topic: 'Linked List', difficulty: 'Medium', name: 'Reorder List',
    lc: 'https://leetcode.com/problems/reorder-list/',
    gfg: 'https://www.geeksforgeeks.org/rearrange-a-given-linked-list-in-place/',
    hr: hr(),
    yt: yt('reorder+list+linked+list+leetcode+solution')
  },
  {
    id: 32, topic: 'Linked List', difficulty: 'Medium', name: 'LRU Cache',
    lc: 'https://leetcode.com/problems/lru-cache/',
    gfg: 'https://www.geeksforgeeks.org/lru-cache-implementation/',
    hr: hr(),
    yt: yt('LRU+cache+implementation+doubly+linked+list+hashmap+leetcode')
  },
  {
    id: 33, topic: 'Linked List', difficulty: 'Medium', name: 'Sort List (Merge Sort)',
    lc: 'https://leetcode.com/problems/sort-list/',
    gfg: 'https://www.geeksforgeeks.org/merge-sort-for-linked-list/',
    hr: hr(),
    yt: yt('sort+linked+list+merge+sort+leetcode+solution')
  },
  {
    id: 34, topic: 'Linked List', difficulty: 'Hard', name: 'Reverse Nodes in k-Group',
    ...
    hr: hr(),
    yt: yt('reverse+nodes+in+k+group+leetcode+hard+solution')
  },

  // ── STACK (9) ────────────────────────────────────────────────
  {
    id: 35, topic: 'Stack', difficulty: 'Easy', name: 'Valid Parentheses',
    ...
    yt: yt('valid+parentheses+stack+leetcode+solution')
  },
  {
    id: 36, topic: 'Stack', difficulty: 'Easy', name: 'Next Greater Element',
    ...
    yt: yt('next+greater+element+monotonic+stack+leetcode')
  },
  {
    id: 37, topic: 'Stack', difficulty: 'Medium', name: 'Min Stack',
    ...
    yt: yt('min+stack+design+O1+leetcode+solution')
  },
  {
    id: 38, topic: 'Stack', difficulty: 'Medium', name: 'Daily Temperatures',
    lc: 'https://leetcode.com/problems/daily-temperatures/',
    gfg: 'https://www.geeksforgeeks.org/daily-temperatures/',
    hr: hr(),
    yt: yt('daily+temperatures+monotonic+stack+leetcode+solution')
  },
  {
    id: 39, topic: 'Stack', difficulty: 'Medium', name: 'Evaluate Reverse Polish Notation',
    ...
    hr: hr(),
    yt: yt('evaluate+reverse+polish+notation+stack+leetcode')
  },
  {
    id: 40, topic: 'Stack', difficulty: 'Medium', name: 'Decode String',
    lc: 'https://leetcode.com/problems/decode-string/',
    gfg: 'https://www.geeksforgeeks.org/decode-string-recursively-encoded-count-followed-string/',
    hr: hr(),
    yt: yt('decode+string+stack+leetcode+solution')
  },
  {
    id: 41, topic: 'Stack', difficulty: 'Medium', name: 'Asteroid Collision',
    lc: 'https://leetcode.com/problems/asteroid-collision/',
    gfg: 'https://www.geeksforgeeks.org/asteroid-collision/',
    hr: hr(),
    yt: yt('asteroid+collision+stack+leetcode+solution')
  },
  {
    id: 42, topic: 'Stack', difficulty: 'Hard', name: 'Largest Rectangle in Histogram',
    ...
    hr: 'https://www.hackerrank.com/challenges/largest-rectangle/problem',
    yt: yt('largest+rectangle+in+histogram+stack+leetcode+hard')
  },
  {
    id: 43, topic: 'Stack', difficulty: 'Hard', name: 'Basic Calculator',
    lc: 'https://leetcode.com/problems/basic-calculator/',
    gfg: 'https://www.geeksforgeeks.org/expression-evaluation/',
    hr: hr(),
    yt: yt('basic+calculator+stack+leetcode+hard+solution')
  },

  // ── QUEUE (6) ────────────────────────────────────────────────
  {
    id: 44, topic: 'Queue', difficulty: 'Easy', name: 'Implement Queue Using Stacks',
    ...
    yt: yt('implement+queue+using+two+stacks+leetcode+solution')
  },
  {
    id: 45, topic: 'Queue', difficulty: 'Easy', name: 'First Unique Character in String',
    ...
    hr: hr(),
    yt: yt('first+unique+character+string+queue+leetcode')
  },
  {
    id: 46, topic: 'Queue', difficulty: 'Medium', name: 'Design Circular Queue',
    lc: 'https://leetcode.com/problems/design-circular-queue/',
    gfg: 'https://www.geeksforgeeks.org/introduction-to-circular-queue/',
    hr: 'https://www.hackerrank.com/challenges/queue-using-two-stacks/problem',
    yt: yt('design+circular+queue+leetcode+solution')
  },
  {
    id: 47, topic: 'Queue', difficulty: 'Medium', name: 'Task Scheduler',
    lc: 'https://leetcode.com/problems/task-scheduler/',
    gfg: 'https://www.geeksforgeeks.org/task-scheduler/',
    hr: hr(),
    yt: yt('task+scheduler+greedy+priority+queue+leetcode')
  },
  {
    id: 48, topic: 'Queue', difficulty: 'Medium', name: 'Number of Recent Calls',
    lc: 'https://leetcode.com/problems/number-of-recent-calls/',
    gfg: 'https://www.geeksforgeeks.org/number-of-recent-calls/',
    hr: hr(),
    yt: yt('number+of+recent+calls+queue+leetcode+solution')
  },
  {
    id: 49, topic: 'Queue', difficulty: 'Hard', name: 'Sliding Window Maximum (Deque)',
    lc: 'https://leetcode.com/problems/sliding-window-maximum/',
    gfg: 'https://www.geeksforgeeks.org/sliding-window-maximum-maximum-of-all-subarrays-of-size-k/',
    hr: hr(),
    yt: yt('sliding+window+maximum+monotonic+deque+leetcode+hard')
  },

  // ── TREES (12) ───────────────────────────────────────────────
  {
    id: 50, topic: 'Trees', difficulty: 'Easy', name: 'Maximum Depth of Binary Tree',
    ...
    yt: yt('maximum+depth+binary+tree+DFS+BFS+leetcode')
  },
  {
    id: 51, topic: 'Trees', difficulty: 'Easy', name: 'Invert Binary Tree',
    ...
    hr: hr(),
    yt: yt('invert+binary+tree+recursive+iterative+leetcode')
  },
  {
    id: 52, topic: 'Trees', difficulty: 'Easy', name: 'Symmetric Tree',
    ...
    yt: yt('symmetric+tree+leetcode+solution+recursive')
  },
  {
    id: 53, topic: 'Trees', difficulty: 'Easy', name: 'Binary Tree Inorder Traversal',
    ...
    yt: yt('binary+tree+inorder+traversal+iterative+stack+leetcode')
  },
  {
    id: 54, topic: 'Trees', difficulty: 'Easy', name: 'Path Sum',
    lc: 'https://leetcode.com/problems/path-sum/',
    gfg: 'https://www.geeksforgeeks.org/root-to-leaf-path-sum-equal-to-a-given-number/',
    hr: hr(),
    yt: yt('path+sum+binary+tree+DFS+leetcode+solution')
  },
  {
    id: 55, topic: 'Trees', difficulty: 'Medium', name: 'Level Order Traversal',
    ...
    yt: yt('level+order+traversal+BFS+queue+binary+tree+leetcode')
  },
  {
    id: 56, topic: 'Trees', difficulty: 'Medium', name: 'Lowest Common Ancestor of BST',
    ...
    yt: yt('lowest+common+ancestor+BST+leetcode+solution')
  },
  {
    id: 57, topic: 'Trees', difficulty: 'Medium', name: 'Validate Binary Search Tree',
    ...
    hr: hr(),
    yt: yt('validate+binary+search+tree+inorder+leetcode')
  },
  {
    id: 58, topic: 'Trees', difficulty: 'Medium', name: 'Kth Smallest in BST',
    ...
    hr: hr(),
    yt: yt('kth+smallest+element+BST+inorder+leetcode')
  },
  {
    id: 59, topic: 'Trees', difficulty: 'Medium', name: 'Construct Tree from Preorder and Inorder',
    ...
    hr: hr(),
    yt: yt('construct+binary+tree+preorder+inorder+traversal+leetcode')
  },
  {
    id: 60, topic: 'Trees', difficulty: 'Hard', name: 'Binary Tree Maximum Path Sum',
    ...
    hr: hr(),
    yt: yt('binary+tree+maximum+path+sum+leetcode+hard+solution')
  },
  {
    id: 61, topic: 'Trees', difficulty: 'Hard', name: 'Serialize and Deserialize Binary Tree',
    ...
    hr: hr(),
    yt: yt('serialize+deserialize+binary+tree+leetcode+hard')
  },

  // ── BFS (7) ──────────────────────────────────────────────────
  {
    id: 62, topic: 'BFS', difficulty: 'Easy', name: 'Minimum Depth of Binary Tree',
    ...
    hr: hr(),
    yt: yt('minimum+depth+binary+tree+BFS+leetcode+solution')
  },
  {
    id: 63, topic: 'BFS', difficulty: 'Medium', name: 'Rotting Oranges',
    ...
    hr: hr(),
    yt: yt('rotting+oranges+multi+source+BFS+leetcode')
  },
  {
    id: 64, topic: 'BFS', difficulty: 'Medium', name: '01 Matrix',
    lc: 'https://leetcode.com/problems/01-matrix/',
    gfg: 'https://www.geeksforgeeks.org/multi-source-shortest-path-in-unweighted-graph/',
    hr: hr(),
    yt: yt('01+matrix+BFS+dynamic+programming+leetcode')
  },
  {
    id: 65, topic: 'BFS', difficulty: 'Medium', name: 'Shortest Path in Binary Matrix',
    ...
    hr: hr(),
    yt: yt('shortest+path+binary+matrix+BFS+leetcode+solution')
  },
  {
    id: 66, topic: 'BFS', difficulty: 'Medium', name: 'Walls and Gates',
    lc: 'https://leetcode.com/problems/walls-and-gates/',
    gfg: 'https://www.geeksforgeeks.org/distance-nearest-cell-having-1-binary-matrix/',
    hr: hr(),
    yt: yt('walls+and+gates+multi+source+BFS+leetcode')
  },
  {
    id: 67, topic: 'BFS', difficulty: 'Medium', name: 'Binary Tree ZigZag Level Order',
    ...
    hr: hr(),
    yt: yt('binary+tree+zigzag+level+order+traversal+BFS+leetcode')
  },
  {
    id: 68, topic: 'BFS', difficulty: 'Hard', name: 'Word Ladder',
    ...
    hr: hr(),
    yt: yt('word+ladder+BFS+shortest+path+leetcode+hard')
  },

  // ── DFS (8) ──────────────────────────────────────────────────
  {
    id: 69, topic: 'DFS', difficulty: 'Easy', name: 'Flood Fill',
    lc: 'https://leetcode.com/problems/flood-fill/',
    gfg: 'https://www.geeksforgeeks.org/flood-fill-algorithm-implement-fill-paint/',
    hr: hr(),
    yt: yt('flood+fill+DFS+BFS+leetcode+solution')
  },
  {
    id: 70, topic: 'DFS', difficulty: 'Medium', name: 'Number of Islands',
    ...
    yt: yt('number+of+islands+DFS+BFS+leetcode+solution')
  },
  {
    id: 71, topic: 'DFS', difficulty: 'Medium', name: 'Max Area of Island',
    lc: 'https://leetcode.com/problems/max-area-of-island/',
    gfg: 'https://www.geeksforgeeks.org/find-the-largest-island-by-flipping-a-zero/',
    hr: hr(),
    yt: yt('max+area+of+island+DFS+leetcode+solution')
  },
  {
    id: 72, topic: 'DFS', difficulty: 'Medium', name: 'Clone Graph',
    lc: 'https://leetcode.com/problems/clone-graph/',
    gfg: 'https://www.geeksforgeeks.org/clone-an-undirected-graph/',
    hr: hr(),
    yt: yt('clone+graph+DFS+BFS+hashmap+leetcode')
  },
  {
    id: 73, topic: 'DFS', difficulty: 'Medium', name: 'Path Sum II',
    lc: 'https://leetcode.com/problems/path-sum-ii/',
    gfg: 'https://www.geeksforgeeks.org/print-all-root-to-leaf-paths-with-there-relative-positions/',
    hr: hr(),
    yt: yt('path+sum+II+backtracking+DFS+leetcode')
  },
  {
    id: 74, topic: 'DFS', difficulty: 'Medium', name: 'Pacific Atlantic Water Flow',
    lc: 'https://leetcode.com/problems/pacific-atlantic-water-flow/',
    gfg: 'https://www.geeksforgeeks.org/pacific-atlantic-water-flow/',
    hr: hr(),
    yt: yt('pacific+atlantic+water+flow+DFS+leetcode')
  },
  {
    id: 75, topic: 'DFS', difficulty: 'Medium', name: 'Surrounded Regions',
    ...
    hr: hr(),
    yt: yt('surrounded+regions+DFS+boundary+leetcode')
  },
  {
    id: 76, topic: 'DFS', difficulty: 'Hard', name: 'Word Search II',
    lc: 'https://leetcode.com/problems/word-search-ii/',
    gfg: 'https://www.geeksforgeeks.org/boggle-find-possible-words-board-characters/',
    hr: hr(),
    yt: yt('word+search+II+trie+backtracking+leetcode+hard')
  },

  // ── GRAPHS (9) ───────────────────────────────────────────────
  {
    id: 77, topic: 'Graphs', difficulty: 'Medium', name: 'BFS of Graph',
    ...
    yt: yt('BFS+graph+traversal+algorithm+explained')
  },
  {
    id: 78, topic: 'Graphs', difficulty: 'Medium', name: 'DFS of Graph',
    ...
    yt: yt('DFS+graph+traversal+algorithm+explained')
  },
  {
    id: 79, topic: 'Graphs', difficulty: 'Medium', name: 'Course Schedule (Topological Sort)',
    ...
    yt: yt('course+schedule+topological+sort+Kahn+DFS+leetcode')
  },
  {
    id: 80, topic: 'Graphs', difficulty: 'Medium', name: 'Number of Connected Components',
    ...
    hr: hr(),
    yt: yt('number+connected+components+undirected+graph+union+find+leetcode')
  },
  {
    id: 81, topic: 'Graphs', difficulty: 'Medium', name: 'Network Delay Time (Dijkstra)',
    ...
    hr: hr(),
    yt: yt('network+delay+time+dijkstra+algorithm+leetcode')
  },
  {
    id: 82, topic: 'Graphs', difficulty: 'Medium', name: 'Cheapest Flights Within K Stops',
    ...
    hr: hr(),
    yt: yt('cheapest+flights+within+k+stops+bellman+ford+leetcode')
  },
  {
    id: 83, topic: 'Graphs', difficulty: 'Medium', name: 'Redundant Connection',
    lc: 'https://leetcode.com/problems/redundant-connection/',
    gfg: 'https://www.geeksforgeeks.org/union-find/',
    hr: hr(),
    yt: yt('redundant+connection+union+find+cycle+detection+leetcode')
  },
  {
    id: 84, topic: 'Graphs', difficulty: 'Hard', name: 'Critical Connections in Network',
    lc: 'https://leetcode.com/problems/critical-connections-in-a-network/',
    gfg: 'https://www.geeksforgeeks.org/bridge-in-a-graph/',
    hr: hr(),
    yt: yt('critical+connections+network+bridges+tarjan+algorithm+leetcode')
  },
  {
    id: 85, topic: 'Graphs', difficulty: 'Hard', name: 'Alien Dictionary',
    ...
    hr: hr(),
    yt: yt('alien+dictionary+topological+sort+leetcode+hard')
  },

  // ── DYNAMIC PROGRAMMING (14) ─────────────────────────────────
  {
    id: 86, topic: 'Dynamic Programming', difficulty: 'Easy', name: 'Climbing Stairs',
    lc: 'https://leetcode.com/problems/climbing-stairs/',
    gfg: 'https://www.geeksforgeeks.org/count-ways-reach-nth-stair/',
    hr: hr(),
    yt: yt('climbing+stairs+dynamic+programming+fibonacci+leetcode')
  },
  {
    id: 87, topic: 'Dynamic Programming', difficulty: 'Medium', name: 'House Robber',
    lc: 'https://leetcode.com/problems/house-robber/',
    gfg: 'https://www.geeksforgeeks.org/find-maximum-possible-stolen-value-houses/',
    hr: hr(),
    yt: yt('house+robber+dynamic+programming+leetcode+solution')
  },
  {
    id: 88, topic: 'Dynamic Programming', difficulty: 'Medium', name: 'Coin Change',
    ...
    yt: yt('coin+change+dynamic+programming+bottom+up+leetcode')
  },
  {
    id: 89, topic: 'Dynamic Programming', difficulty: 'Medium', name: 'Longest Common Subsequence',
    ...
    yt: yt('longest+common+subsequence+dynamic+programming+2D+DP+leetcode')
  },
  {
    id: 90, topic: 'Dynamic Programming', difficulty: 'Medium', name: '0/1 Knapsack',
    ...
    yt: yt('0+1+knapsack+problem+dynamic+programming+explained')
  },
  {
    id: 91, topic: 'Dynamic Programming', difficulty: 'Medium', name: 'Longest Increasing Subsequence',
    ...
    yt: yt('longest+increasing+subsequence+DP+binary+search+leetcode')
  },
  {
    id: 92, topic: 'Dynamic Programming', difficulty: 'Medium', name: 'Word Break',
    lc: 'https://leetcode.com/problems/word-break/',
    gfg: 'https://www.geeksforgeeks.org/word-break-problem-dp-32/',
    hr: hr(),
    yt: yt('word+break+dynamic+programming+leetcode+solution')
  },
  {
    id: 93, topic: 'Dynamic Programming', difficulty: 'Medium', name: 'Unique Paths',
    lc: 'https://leetcode.com/problems/unique-paths/',
    gfg: 'https://www.geeksforgeeks.org/count-possible-paths-top-left-bottom-right-nxmmatrix/',
    hr: hr(),
    yt: yt('unique+paths+dynamic+programming+grid+leetcode')
  },
  {
    id: 94, topic: 'Dynamic Programming', difficulty: 'Medium', name: 'Maximum Product Subarray',
    lc: 'https://leetcode.com/problems/maximum-product-subarray/',
    gfg: 'https://www.geeksforgeeks.org/maximum-product-subarray/',
    hr: hr(),
    yt: yt('maximum+product+subarray+dynamic+programming+leetcode')
  },
  {
    id: 95, topic: 'Dynamic Programming', difficulty: 'Medium', name: 'Decode Ways',
    lc: 'https://leetcode.com/problems/decode-ways/',
    gfg: 'https://www.geeksforgeeks.org/count-possible-decodings-given-digit-sequence/',
    hr: hr(),
    yt: yt('decode+ways+dynamic+programming+leetcode+solution')
  },
  {
    id: 96, topic: 'Dynamic Programming', difficulty: 'Hard', name: 'Edit Distance',
    lc: 'https://leetcode.com/problems/edit-distance/',
    gfg: 'https://www.geeksforgeeks.org/edit-distance-dp-5/',
    hr: hr(),
    yt: yt('edit+distance+dynamic+programming+2D+DP+leetcode+hard')
  },
  {
    id: 97, topic: 'Dynamic Programming', difficulty: 'Hard', name: 'Burst Balloons',
    lc: 'https://leetcode.com/problems/burst-balloons/',
    gfg: 'https://www.geeksforgeeks.org/burst-balloon-to-maximize-coins/',
    hr: hr(),
    yt: yt('burst+balloons+interval+DP+leetcode+hard+solution')
  },
  {
    id: 98, topic: 'Dynamic Programming', difficulty: 'Hard', name: 'Palindrome Partitioning II',
    lc: 'https://leetcode.com/problems/palindrome-partitioning-ii/',
    gfg: 'https://www.geeksforgeeks.org/palindrome-partitioning-dp-17/',
    hr: hr(),
    yt: yt('palindrome+partitioning+II+minimum+cuts+DP+leetcode')
  },
  {
    id: 99, topic: 'Dynamic Programming', difficulty: 'Hard', name: 'Matrix Chain Multiplication',
    ...
    hr: hr(),
    yt: yt('matrix+chain+multiplication+dynamic+programming+explained')
  },

  // ── BACKTRACKING (8) ─────────────────────────────────────────
  {
    id: 100, topic: 'Backtracking', difficulty: 'Medium', name: 'Subsets',
    lc: 'https://leetcode.com/problems/subsets/',
    gfg: 'https://www.geeksforgeeks.org/backtracking-to-find-all-subsets/',
    hr: 'https://www.hackerrank.com/challenges/crossword-puzzle/problem',
    yt: yt('subsets+backtracking+power+set+leetcode+solution')
  },
  {
    id: 101, topic: 'Backtracking', difficulty: 'Medium', name: 'Permutations',
    ...
    hr: hr(),
    yt: yt('permutations+backtracking+leetcode+solution')
  },
  {
    id: 102, topic: 'Backtracking', difficulty: 'Medium', name: 'Combination Sum',
    lc: 'https://leetcode.com/problems/combination-sum/',
    gfg: 'https://www.geeksforgeeks.org/combinational-sum/',
    hr: hr(),
    yt: yt('combination+sum+backtracking+leetcode+solution')
  },
  {
    id: 103, topic: 'Backtracking', difficulty: 'Medium', name: 'Letter Combinations of Phone Number',
    ...
    hr: hr(),
    yt: yt('letter+combinations+phone+number+backtracking+leetcode')
  },
  {
    id: 104, topic: 'Backtracking', difficulty: 'Medium', name: 'Palindrome Partitioning',
    ...
    hr: hr(),
    yt: yt('palindrome+partitioning+backtracking+leetcode+solution')
  },
  {
    id: 105, topic: 'Backtracking', difficulty: 'Medium', name: 'Word Search',
    lc: 'https://leetcode.com/problems/word-search/',
    gfg: 'https://www.geeksforgeeks.org/search-a-word-in-a-2d-grid-of-characters/',
    hr: hr(),
    yt: yt('word+search+backtracking+DFS+leetcode+solution')
  },
  {
    id: 106, topic: 'Backtracking', difficulty: 'Hard', name: 'N-Queens',
    lc: 'https://leetcode.com/problems/n-queens/',
    gfg: 'https://www.geeksforgeeks.org/n-queen-problem-backtracking-3/',
    hr: hr(),
    yt: yt('n+queens+backtracking+leetcode+hard+solution')
  },
  {
    id: 107, topic: 'Backtracking', difficulty: 'Hard', name: 'Sudoku Solver',
    lc: 'https://leetcode.com/problems/sudoku-solver/',
    gfg: 'https://www.geeksforgeeks.org/sudoku-backtracking-7/',
    hr: hr(),
    yt: yt('sudoku+solver+backtracking+leetcode+hard+solution')
  },
];

const ALL_TOPICS = ['All', ...new Set(DSA_PROBLEMS.map(p => p.topic))];
const ALL_DIFFS = ['All', 'Easy', 'Medium', 'Hard'];

const DIFF_COLOR = { Easy: '#06D6A0', Medium: '#FFD93D', Hard: '#FF6B6B' };
const DIFF_BG = { Easy: 'rgba(6,214,160,0.12)', Medium: 'rgba(255,217,61,0.12)', Hard: 'rgba(255,107,107,0.12)' };
const TOPIC_EMOJI = {
  Arrays: '📦', Strings: '🔤', 'Linked List': '🔗', Stack: '📚', Queue: '🎯',
  Trees: '🌳', BFS: '🌊', DFS: '🔍', Graphs: '🕸️', 'Dynamic Programming': '⚡', Backtracking: '♟️',
};
const TOPIC_COLOR = {
  Arrays: '#FF6B6B', Strings: '#A29BFE', 'Linked List': '#74B9FF', Stack: '#FDCB6E',
  Queue: '#E17055', Trees: '#55EFC4', BFS: '#00CEC9', DFS: '#6C5CE7',
...
export default function Placement() {
  ...
  useEffect(() => {
    API.get('/placement/completed-dsa')
      .then(r => setCompleted(new Set(r.data.completed || [])))
      .catch(() => { });
  ...
  const markDone = useCallback(async (name) => {
    if (completed.has(name) || marking.has(name)) return;
    setMarking(prev => new Set([...prev, name]));
    try {
      await API.post('/placement/mark-done', { problem_name: name });
      setCompleted(prev => new Set([...prev, name]));
    } catch (err) {
      console.error('markDone error:', err);
    } finally {
      setMarking(prev => { const n = new Set(prev); n.delete(name); return n; });
    }
  }, [completed, marking]);
  ...
  const doneCount = DSA_PROBLEMS.filter(p => completed.has(p.name)).length;
  ...
  return (
    <div style={{ maxWidth: 1080, fontFamily: 'Nunito,sans-serif' }}>
      ...
      <p style={{ color: '#7A7A9D', marginBottom: 24, fontSize: 14 }}>
        {totalCount} DSA problems · LeetCode, GFG, HackerRank & YouTube Search — all in one place
      </p>
      ...
      <div style={{ display: 'flex', gap: 8, marginBottom: 28, flexWrap: 'wrap' }}>
        {TABS.map(t => (
          <button key={t.key} onClick={() => { setTab(t.key); setSearch(''); }} style={{
            ...
            background: tab === t.key ? 'rgba(124,92,252,0.9)' : 'rgba(255,255,255,0.04)',
            color: tab === t.key ? '#fff' : '#A29BFE',
            transition: 'all 0.2s',
          }}>{t.label}</button>
        ))}
      </div>
        ...
        <div>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
              <div>
                <span style={{ fontWeight: 900, fontSize: 16, color: '#F0F0FF' }}>Overall Progress</span>
                <span style={{ color: '#7A7A9D', fontSize: 13, marginLeft: 10 }}>{doneCount} / {totalCount} solved</span>
              </div>
              <span style={{ fontWeight: 900, fontSize: 22, color: pct >= 70 ? '#06D6A0' : pct >= 40 ? '#FFD93D' : '#A29BFE' }}>{pct}%</span>
            </div>
            <div style={{ height: 10, background: 'rgba(255,255,255,0.08)', borderRadius: 99, overflow: 'hidden' }}>
              <div style={{
                ...
                background: pct >= 70 ? 'linear-gradient(90deg,#06D6A0,#00b894)' : pct >= 40 ? 'linear-gradient(90deg,#FFD93D,#fdcb6e)' : 'linear-gradient(90deg,#A29BFE,#7C5CFC)',
              }} />
            </div>
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10, marginTop: 14 }}>
              {ALL_TOPICS.filter(t => t !== 'All').map(t => {
                const tot = DSA_PROBLEMS.filter(p => p.topic === t).length;
                const done = DSA_PROBLEMS.filter(p => p.topic === t && completed.has(p.name)).length;
                const col = TOPIC_COLOR[t] || '#A29BFE';
                return (
                  <div key={t} style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
                    <span style={{ width: 8, height: 8, borderRadius: '50%', background: col, flexShrink: 0 }} />
                    <span style={{ fontSize: 11, color: '#7A7A9D', fontWeight: 700 }}>{TOPIC_EMOJI[t]} {t}</span>
                    <span style={{ fontSize: 11, color: col, fontWeight: 900 }}>{done}/{tot}</span>
                  </div>
                );
              })}
            </div>
          ...
          <div style={{ display: 'flex', gap: 12, marginBottom: 14, flexWrap: 'wrap', alignItems: 'center' }}>
            <input value={search} onChange={e => setSearch(e.target.value)} placeholder="🔍  Search problem name..."
              style={{
                padding: '10px 16px', borderRadius: 12, outline: 'none', border: '2px solid rgba(255,255,255,0.1)',
                background: 'rgba(255,255,255,0.05)', color: '#F0F0FF', fontSize: 13, fontWeight: 600, width: 230, fontFamily: 'Nunito,sans-serif'
              }} />
            <div style={{ display: 'flex', gap: 5 }}>
              {ALL_DIFFS.map(d => (
                <button key={d} onClick={() => setDiff(d)} style={{
                  padding: '7px 13px', borderRadius: 10, cursor: 'pointer', fontWeight: 800, fontSize: 12, fontFamily: 'Nunito,sans-serif',
                  border: `2px solid ${d === 'All' ? '#A29BFE55' : DIFF_COLOR[d] + '55'}`,
                  background: diff === d ? (d === 'All' ? '#A29BFE' : DIFF_COLOR[d]) : 'rgba(255,255,255,0.04)',
                  color: diff === d ? '#fff' : (d === 'All' ? '#A29BFE' : DIFF_COLOR[d]),
          ...
          <div style={{ display: 'flex', gap: 6, marginBottom: 16, flexWrap: 'wrap' }}>
            {ALL_TOPICS.map(t => {
              const col = t === 'All' ? '#7A7A9D' : (TOPIC_COLOR[t] || '#A29BFE');
              const emoji = t === 'All' ? '🔷' : (TOPIC_EMOJI[t] || '');
              const cnt = t === 'All' ? totalCount : DSA_PROBLEMS.filter(p => p.topic === t).length;
              return (
                <button key={t} onClick={() => setTopic(t)} style={{
                  padding: '6px 13px', borderRadius: 20, cursor: 'pointer', fontWeight: 700, fontSize: 12, fontFamily: 'Nunito,sans-serif',
                  border: `1.5px solid ${col}55`,
                  background: topic === t ? col : 'rgba(255,255,255,0.03)',
                  color: topic === t ? '#fff' : col, transition: 'all 0.15s',
                }}>{emoji} {t} ({cnt})</button>
              );
            })}
          </div>

          <div style={{ color: '#7A7A9D', fontSize: 12, fontWeight: 700, marginBottom: 12 }}>
            Showing {filtered.length} problem{filtered.length !== 1 ? 's' : ''}
            {topic !== 'All' && ` · ${topic}`}{diff !== 'All' && ` · ${diff}`}{search && ` · matching "${search}"`}
          </div>

          {filtered.length === 0 ? (
            <div style={{ textAlign: 'center', padding: 60, color: '#7A7A9D' }}>
              <div style={{ fontSize: 48, marginBottom: 12 }}>🔍</div>
              <div style={{ fontWeight: 800, fontSize: 16 }}>No problems match your filters</div>
              <button onClick={() => { setTopic('All'); setDiff('All'); setSearch(''); }}
                style={{
                  marginTop: 14, padding: '8px 20px', borderRadius: 10, cursor: 'pointer',
                  background: 'rgba(162,155,254,0.15)', border: '1.5px solid #A29BFE55',
                  color: '#A29BFE', fontWeight: 800, fontSize: 13, fontFamily: 'Nunito,sans-serif'
                }}>
                Clear Filters
              </button>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              {filtered.map((p, idx) => {
                ...
                const isMarking = marking.has(p.name);
                const tCol = TOPIC_COLOR[p.topic] || '#A29BFE';
                return (
                  <div key={p.id} style={{
                    background: isDone ? 'rgba(6,214,160,0.04)' : 'rgba(255,255,255,0.025)',
                    borderRadius: 16, padding: '12px 18px',
                    border: isDone ? '1px solid rgba(6,214,160,0.3)' : '1px solid rgba(255,255,255,0.07)',
                    display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12, flexWrap: 'wrap',
                    transition: 'border-color 0.3s, background 0.3s',
                  }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 12, minWidth: 0, flex: 1 }}>
                      <div style={{
                        width: 32, height: 32, borderRadius: 9, flexShrink: 0, background: `${tCol}18`,
                        display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 900, fontSize: 12, color: tCol
                      }}>
                        {idx + 1}
                      </div>
                      <div style={{ minWidth: 0 }}>
                        <div style={{ fontWeight: 800, fontSize: 14, color: '#F0F0FF', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                          {p.name}
                        </div>
                        <div style={{ display: 'flex', gap: 5, marginTop: 4, flexWrap: 'wrap' }}>
                          <span style={{ fontSize: 11, fontWeight: 800, padding: '2px 8px', borderRadius: 6, background: `${tCol}18`, color: tCol }}>
                            {TOPIC_EMOJI[p.topic]} {p.topic}
                          </span>
                          <span style={{ fontSize: 11, fontWeight: 800, padding: '2px 8px', borderRadius: 6, background: DIFF_BG[p.difficulty], color: DIFF_COLOR[p.difficulty] }}>
                            {p.difficulty}
                          </span>
                        </div>
                      </div>
                    ...
                    <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap', alignItems: 'center', flexShrink: 0 }}>
                      <LinkBtn href={p.lc} icon="🟨" label="LeetCode" color="#F89F1B" />
                      <LinkBtn href={p.gfg} icon="🟩" label="GFG" color="#2F8D46" />
                      <LinkBtn href={p.hr} icon="⬛" label="HackerRank" color="#00EA64" />
                      <LinkBtn href={p.yt} icon="▶" label="YouTube" color="#FF0000" />
                      <button onClick={() => markDone(p.name)} disabled={isDone || isMarking} style={{
                        padding: '5px 13px', borderRadius: 8, cursor: isDone ? 'default' : 'pointer',
                        fontWeight: 800, fontSize: 12, fontFamily: 'Nunito,sans-serif',
                        border: `1.5px solid ${isDone ? '#06D6A0' : '#7A7A9D55'}`,
                        background: isDone ? 'rgba(6,214,160,0.12)' : 'transparent',
                        color: isDone ? '#06D6A0' : '#7A7A9D', transition: 'all 0.2s', whiteSpace: 'nowrap',
                      }}>
                        {isMarking ? '⏳' : isDone ? '✅ Done' : 'Mark Done'}
                      </button>
                    </div>
                  </div>
                );
...
const APTITUDE_SECTIONS = [
  // ── QUANTITATIVE APTITUDE (35 topics) ────────────────────────
  {
    title: '📐 Quantitative Aptitude', color: '#A29BFE',
    topics: [
      { name: 'Problems on Trains', ib: 'https://www.indiabix.com/aptitude/problems-on-trains/', yt: yt('problems+on+trains+aptitude+tricks') },
      { name: 'Time and Distance', ib: 'https://www.indiabix.com/aptitude/time-and-distance/', yt: yt('time+and+distance+aptitude+tricks+shortcuts') },
      { name: 'Height and Distance', ib: 'https://www.indiabix.com/aptitude/height-and-distance/', yt: yt('height+and+distance+aptitude+trigonometry') },
      { name: 'Time and Work', ib: 'https://www.indiabix.com/aptitude/time-and-work/', yt: yt('time+and+work+aptitude+tricks+shortcuts') },
      { name: 'Simple Interest', ib: 'https://www.indiabix.com/aptitude/simple-interest/', yt: yt('simple+interest+aptitude+tricks') },
      { name: 'Compound Interest', ib: 'https://www.indiabix.com/aptitude/compound-interest/', yt: yt('compound+interest+aptitude+tricks') },
      { name: 'Profit and Loss', ib: 'https://www.indiabix.com/aptitude/profit-and-loss/', yt: yt('profit+and+loss+aptitude+tricks') },
      { name: 'Partnership', ib: 'https://www.indiabix.com/aptitude/partnership/', yt: yt('partnership+aptitude+problems+tricks') },
      { name: 'Percentage', ib: 'https://www.indiabix.com/aptitude/percentage/', yt: yt('percentage+aptitude+tricks+shortcuts') },
      { name: 'Problems on Ages', ib: 'https://www.indiabix.com/aptitude/problems-on-ages/', yt: yt('problems+on+ages+aptitude+tricks') },
      { name: 'Calendar', ib: 'https://www.indiabix.com/aptitude/calendar/', yt: yt('calendar+aptitude+day+of+week+tricks') },
      { name: 'Clock', ib: 'https://www.indiabix.com/aptitude/clock/', yt: yt('clock+aptitude+angle+tricks+shortcuts') },
      { name: 'Average', ib: 'https://www.indiabix.com/aptitude/average/', yt: yt('average+aptitude+tricks+placement') },
      { name: 'Area', ib: 'https://www.indiabix.com/aptitude/area/', yt: yt('area+mensuration+aptitude+tricks') },
      { name: 'Volume and Surface Area', ib: 'https://www.indiabix.com/aptitude/volume-and-surface-area/', yt: yt('volume+surface+area+aptitude+3D+shapes') },
      { name: 'Permutation and Combination', ib: 'https://www.indiabix.com/aptitude/permutation-and-combination/', yt: yt('permutation+combination+aptitude+placement') },
      { name: 'Numbers', ib: 'https://www.indiabix.com/aptitude/numbers/', yt: yt('number+system+aptitude+placement') },
      { name: 'Problems on Numbers', ib: 'https://www.indiabix.com/aptitude/problems-on-numbers/', yt: yt('problems+on+numbers+aptitude+tricks') },
      { name: 'Problems on H.C.F and L.C.M', ib: 'https://www.indiabix.com/aptitude/problems-on-hcf-and-lcm/', yt: yt('hcf+lcm+problems+aptitude+tricks') },
      { name: 'Decimal Fraction', ib: 'https://www.indiabix.com/aptitude/decimal-fraction/', yt: yt('decimal+fraction+aptitude+tricks') },
      { name: 'Simplification', ib: 'https://www.indiabix.com/aptitude/simplification/', yt: yt('simplification+aptitude+BODMAS+tricks') },
      { name: 'Square Root and Cube Root', ib: 'https://www.indiabix.com/aptitude/square-root-and-cube-root/', yt: yt('square+root+cube+root+aptitude+tricks') },
      { name: 'Surds and Indices', ib: 'https://www.indiabix.com/aptitude/surds-and-indices/', yt: yt('surds+and+indices+aptitude+tricks') },
      { name: 'Ratio and Proportion', ib: 'https://www.indiabix.com/aptitude/ratio-and-proportion/', yt: yt('ratio+and+proportion+aptitude+tricks') },
      { name: 'Chain Rule', ib: 'https://www.indiabix.com/aptitude/chain-rule/', yt: yt('chain+rule+aptitude+direct+inverse+proportion') },
      { name: 'Pipes and Cistern', ib: 'https://www.indiabix.com/aptitude/pipes-and-cistern/', yt: yt('pipes+and+cistern+aptitude+tricks') },
      { name: 'Boats and Streams', ib: 'https://www.indiabix.com/aptitude/boats-and-streams/', yt: yt('boats+and+streams+aptitude+tricks') },
      { name: 'Alligation or Mixture', ib: 'https://www.indiabix.com/aptitude/alligation-or-mixture/', yt: yt('alligation+mixture+aptitude+tricks') },
      { name: 'Logarithm', ib: 'https://www.indiabix.com/aptitude/logarithm/', yt: yt('logarithm+aptitude+tricks+placement') },
      { name: 'Races and Games', ib: 'https://www.indiabix.com/aptitude/races-and-games/', yt: yt('races+and+games+aptitude+problems') },
      { name: 'Stocks and Shares', ib: 'https://www.indiabix.com/aptitude/stocks-and-shares/', yt: yt('stocks+and+shares+aptitude+problems') },
      { name: 'Probability', ib: 'https://www.indiabix.com/aptitude/probability/', yt: yt('probability+aptitude+problems+placement') },
      { name: 'True Discount', ib: 'https://www.indiabix.com/aptitude/true-discount/', yt: yt('true+discount+aptitude+problems') },
      { name: "Banker's Discount", ib: 'https://www.indiabix.com/aptitude/bankers-discount/', yt: yt('bankers+discount+aptitude+problems') },
      { name: 'Odd Man Out and Series', ib: 'https://www.indiabix.com/aptitude/odd-man-out-and-series/', yt: yt('odd+man+out+series+aptitude+tricks') },
    ],
  },

  // ── LOGICAL REASONING (19 topics) ────────────────────────────
  {
    title: '🧩 Logical Reasoning', color: '#FFD93D',
    topics: [
      { name: 'Number Series', ib: 'https://www.indiabix.com/logical-reasoning/number-series/', yt: yt('number+series+logical+reasoning+tricks') },
      { name: 'Letter and Symbol Series', ib: 'https://www.indiabix.com/logical-reasoning/letter-and-symbol-series/', yt: yt('letter+symbol+series+reasoning+tricks') },
      { name: 'Verbal Classification', ib: 'https://www.indiabix.com/logical-reasoning/verbal-classification/', yt: yt('verbal+classification+logical+reasoning') },
      { name: 'Essential Part', ib: 'https://www.indiabix.com/logical-reasoning/essential-part/', yt: yt('essential+part+logical+reasoning+placement') },
      { name: 'Analogies', ib: 'https://www.indiabix.com/logical-reasoning/analogies/', yt: yt('analogies+logical+reasoning+tricks') },
      { name: 'Artificial Language', ib: 'https://www.indiabix.com/logical-reasoning/artificial-language/', yt: yt('artificial+language+logical+reasoning') },
      { name: 'Matching Definitions', ib: 'https://www.indiabix.com/logical-reasoning/matching-definitions/', yt: yt('matching+definitions+logical+reasoning') },
      { name: 'Making Judgments', ib: 'https://www.indiabix.com/logical-reasoning/making-judgments/', yt: yt('making+judgments+logical+reasoning') },
      { name: 'Verbal Reasoning', ib: 'https://www.indiabix.com/logical-reasoning/verbal-reasoning/', yt: yt('verbal+reasoning+tricks+placement') },
      { name: 'Logical Problems', ib: 'https://www.indiabix.com/logical-reasoning/logical-problems/', yt: yt('logical+problems+reasoning+placement') },
      { name: 'Logical Games', ib: 'https://www.indiabix.com/logical-reasoning/logical-games/', yt: yt('logical+games+reasoning+placement') },
      { name: 'Analyzing Arguments', ib: 'https://www.indiabix.com/logical-reasoning/analyzing-arguments/', yt: yt('analyzing+arguments+logical+reasoning') },
      { name: 'Statement and Assumption', ib: 'https://www.indiabix.com/logical-reasoning/statement-and-assumption/', yt: yt('statement+and+assumption+reasoning+tricks') },
      { name: 'Course of Action', ib: 'https://www.indiabix.com/logical-reasoning/course-of-action/', yt: yt('course+of+action+logical+reasoning+tricks') },
      { name: 'Statement and Conclusion', ib: 'https://www.indiabix.com/logical-reasoning/statement-and-conclusion/', yt: yt('statement+and+conclusion+reasoning+tricks') },
      { name: 'Theme Detection', ib: 'https://www.indiabix.com/logical-reasoning/theme-detection/', yt: yt('theme+detection+logical+reasoning+placement') },
      { name: 'Cause and Effect', ib: 'https://www.indiabix.com/logical-reasoning/cause-and-effect/', yt: yt('cause+and+effect+logical+reasoning+tricks') },
      { name: 'Statement and Argument', ib: 'https://www.indiabix.com/logical-reasoning/statement-and-argument/', yt: yt('statement+and+argument+reasoning+tricks') },
      { name: 'Logical Deduction', ib: 'https://www.indiabix.com/logical-reasoning/logical-deduction/', yt: yt('logical+deduction+syllogism+reasoning+tricks') },
    ],
  },

  // ── VERBAL ABILITY (19 topics) ───────────────────────────────
  {
    title: '📝 Verbal Ability', color: '#74B9FF',
    topics: [
      { name: 'Spotting Errors', ib: 'https://www.indiabix.com/verbal-ability/spotting-errors/', yt: yt('spotting+errors+verbal+ability+placement') },
      { name: 'Synonyms', ib: 'https://www.indiabix.com/verbal-ability/synonyms/', yt: yt('synonyms+verbal+ability+english+placement') },
      { name: 'Antonyms', ib: 'https://www.indiabix.com/verbal-ability/antonyms/', yt: yt('antonyms+verbal+ability+english+placement') },
      { name: 'Selecting Words', ib: 'https://www.indiabix.com/verbal-ability/selecting-words/', yt: yt('selecting+words+fill+blanks+verbal+ability') },
      { name: 'Spellings', ib: 'https://www.indiabix.com/verbal-ability/spellings/', yt: yt('spellings+verbal+ability+english+placement') },
      { name: 'Sentence Formation', ib: 'https://www.indiabix.com/verbal-ability/sentence-formation/', yt: yt('sentence+formation+verbal+ability+placement') },
      { name: 'Ordering of Words', ib: 'https://www.indiabix.com/verbal-ability/ordering-of-words/', yt: yt('ordering+of+words+verbal+ability+placement') },
      { name: 'Sentence Correction', ib: 'https://www.indiabix.com/verbal-ability/sentence-correction/', yt: yt('sentence+correction+english+grammar+placement') },
      { name: 'Sentence Improvement', ib: 'https://www.indiabix.com/verbal-ability/sentence-improvement/', yt: yt('sentence+improvement+verbal+ability+placement') },
      { name: 'Completing Statements', ib: 'https://www.indiabix.com/verbal-ability/completing-statements/', yt: yt('completing+statements+verbal+ability+placement') },
      { name: 'Ordering of Sentences', ib: 'https://www.indiabix.com/verbal-ability/ordering-of-sentences/', yt: yt('ordering+of+sentences+para+jumbles+placement') },
      { name: 'Paragraph Formation', ib: 'https://www.indiabix.com/verbal-ability/paragraph-formation/', yt: yt('paragraph+formation+verbal+ability+placement') },
      { name: 'Cloze Test', ib: 'https://www.indiabix.com/verbal-ability/closet-test/', yt: yt('cloze+test+verbal+ability+english+placement') },
      { name: 'Comprehension', ib: 'https://www.indiabix.com/verbal-ability/comprehension/', yt: yt('reading+comprehension+verbal+ability+placement') },
      { name: 'One Word Substitutes', ib: 'https://www.indiabix.com/verbal-ability/one-word-substitutes/', yt: yt('one+word+substitution+verbal+ability+placement') },
      { name: 'Idioms and Phrases', ib: 'https://www.indiabix.com/verbal-ability/idioms-and-phrases/', yt: yt('idioms+and+phrases+verbal+ability+placement') },
      { name: 'Change of Voice', ib: 'https://www.indiabix.com/verbal-ability/change-of-voice/', yt: yt('active+passive+voice+change+verbal+ability') },
      { name: 'Change of Speech', ib: 'https://www.indiabix.com/verbal-ability/change-of-speech/', yt: yt('direct+indirect+speech+change+verbal+ability') },
      { name: 'Verbal Analogies', ib: 'https://www.indiabix.com/verbal-ability/verbal-analogies/', yt: yt('verbal+analogies+english+placement+tricks') },
    ],
  },

  // ── DATA INTERPRETATION (4 topics) ──────────────────────────
  {
    title: '📊 Data Interpretation', color: '#55EFC4',
    topics: [
      { name: 'Table Charts', ib: 'https://www.indiabix.com/data-interpretation/table-charts/', yt: yt('table+charts+data+interpretation+tricks') },
      { name: 'Bar Charts', ib: 'https://www.indiabix.com/data-interpretation/bar-charts/', yt: yt('bar+charts+data+interpretation+placement') },
      { name: 'Pie Charts', ib: 'https://www.indiabix.com/data-interpretation/pie-charts/', yt: yt('pie+charts+data+interpretation+tricks') },
      { name: 'Line Charts', ib: 'https://www.indiabix.com/data-interpretation/line-charts/', yt: yt('line+charts+data+interpretation+placement') },
    ],
  },

  // ── NON VERBAL REASONING (17 topics) ────────────────────────
  {
    title: '🔷 Non Verbal Reasoning', color: '#FD79A8',
    topics: [
      { name: 'Series', ib: 'https://www.indiabix.com/non-verbal-reasoning/series/', yt: yt('non+verbal+reasoning+series+figure+tricks') },
      { name: 'Analogy', ib: 'https://www.indiabix.com/non-verbal-reasoning/analogy/', yt: yt('non+verbal+reasoning+analogy+figure+placement') },
      { name: 'Classification', ib: 'https://www.indiabix.com/non-verbal-reasoning/classification/', yt: yt('non+verbal+reasoning+classification+odd+figure') },
      { name: 'Analytical Reasoning', ib: 'https://www.indiabix.com/non-verbal-reasoning/analytical-reasoning/', yt: yt('analytical+reasoning+non+verbal+placement') },
      { name: 'Mirror Images', ib: 'https://www.indiabix.com/non-verbal-reasoning/mirror-images/', yt: yt('mirror+images+non+verbal+reasoning+tricks') },
      { name: 'Water Images', ib: 'https://www.indiabix.com/non-verbal-reasoning/water-images/', yt: yt('water+images+non+verbal+reasoning+tricks') },
      { name: 'Embedded Images', ib: 'https://www.indiabix.com/non-verbal-reasoning/embedded-images/', yt: yt('embedded+images+non+verbal+reasoning') },
      { name: 'Pattern Completion', ib: 'https://www.indiabix.com/non-verbal-reasoning/pattern-completion/', yt: yt('pattern+completion+non+verbal+reasoning+tricks') },
      { name: 'Figure Matrix', ib: 'https://www.indiabix.com/non-verbal-reasoning/figure-matrix/', yt: yt('figure+matrix+non+verbal+reasoning+placement') },
      { name: 'Paper Folding', ib: 'https://www.indiabix.com/non-verbal-reasoning/paper-folding/', yt: yt('paper+folding+non+verbal+reasoning+tricks') },
      { name: 'Paper Cutting', ib: 'https://www.indiabix.com/non-verbal-reasoning/paper-cutting/', yt: yt('paper+cutting+non+verbal+reasoning+tricks') },
      { name: 'Rule Detection', ib: 'https://www.indiabix.com/non-verbal-reasoning/rule-detection/', yt: yt('rule+detection+non+verbal+reasoning+placement') },
      { name: 'Grouping of Images', ib: 'https://www.indiabix.com/non-verbal-reasoning/grouping-of-images/', yt: yt('grouping+of+images+non+verbal+reasoning') },
      { name: 'Dot Situation', ib: 'https://www.indiabix.com/non-verbal-reasoning/dot-situation/', yt: yt('dot+situation+non+verbal+reasoning+tricks') },
      { name: 'Shape Construction', ib: 'https://www.indiabix.com/non-verbal-reasoning/shape-construction/', yt: yt('shape+construction+non+verbal+reasoning') },
      { name: 'Image Analysis', ib: 'https://www.indiabix.com/non-verbal-reasoning/image-analysis/', yt: yt('image+analysis+non+verbal+reasoning+placement') },
      { name: 'Cubes and Dice', ib: 'https://www.indiabix.com/non-verbal-reasoning/cubes-and-dice/', yt: yt('cubes+and+dice+non+verbal+reasoning+tricks') },
    ],
  },
];
...
//     title: '📐 Quantitative Aptitude', color: '#A29BFE',
//     topics: [
//       { name: 'Percentages', ib: 'https://www.indiabix.com/aptitude/percentage/', yt: yt('percentage+aptitude+tricks+shortcuts') },
//       { name: 'Profit & Loss', ib: 'https://www.indiabix.com/aptitude/profit-and-loss/', yt: yt('profit+and+loss+aptitude+tricks') },
//       { name: 'Time & Work', ib: 'https://www.indiabix.com/aptitude/time-and-work/', yt: yt('time+and+work+aptitude+tricks+shortcuts') },
//       { name: 'Speed & Distance', ib: 'https://www.indiabix.com/aptitude/time-and-distance/', yt: yt('speed+distance+time+aptitude+problems') },
//       { name: 'Number System', ib: 'https://www.indiabix.com/aptitude/numbers/', yt: yt('number+system+aptitude+placement') },
//       { name: 'HCF & LCM', ib: 'https://www.indiabix.com/aptitude/hcf-and-lcm/', yt: yt('hcf+lcm+aptitude+tricks+shortcuts') },
//       { name: 'Permutation & Combination', ib: 'https://www.indiabix.com/aptitude/permutation-and-combination/', yt: yt('permutation+combination+aptitude+placement') },
//       { name: 'Probability', ib: 'https://www.indiabix.com/aptitude/probability/', yt: yt('probability+aptitude+problems+placement') },
//       { name: 'Averages', ib: 'https://www.indiabix.com/aptitude/average/', yt: yt('averages+aptitude+tricks+placement') },
//       { name: 'Ratio & Proportion', ib: 'https://www.indiabix.com/aptitude/ratio-and-proportion/', yt: yt('ratio+proportion+aptitude+tricks') },
//       { name: 'Simple Interest', ib: 'https://www.indiabix.com/aptitude/simple-interest/', yt: yt('simple+interest+aptitude+tricks') },
//       { name: 'Compound Interest', ib: 'https://www.indiabix.com/aptitude/compound-interest/', yt: yt('compound+interest+aptitude+tricks') },
//       { name: 'Ages Problems', ib: 'https://www.indiabix.com/aptitude/problems-on-ages/', yt: yt('problems+on+ages+aptitude+tricks') },
//       { name: 'Trains', ib: 'https://www.indiabix.com/aptitude/problems-on-trains/', yt: yt('trains+aptitude+problems+tricks') },
//       { name: 'Boats & Streams', ib: 'https://www.indiabix.com/aptitude/boats-and-streams/', yt: yt('boats+and+streams+aptitude+tricks') },
//       { name: 'Pipes & Cisterns', ib: 'https://www.indiabix.com/aptitude/pipes-and-cisterns/', yt: yt('pipes+and+cisterns+aptitude+tricks') },
//       { name: 'Mixtures & Alligations', ib: 'https://www.indiabix.com/aptitude/alligation-or-mixture/', yt: yt('mixtures+alligations+aptitude+tricks') },
//       { name: 'Mensuration', ib: 'https://www.indiabix.com/aptitude/area/', yt: yt('mensuration+aptitude+area+volume+problems') },
//       { name: 'Partnership', ib: 'https://www.indiabix.com/aptitude/partnership/', yt: yt('partnership+aptitude+problems+tricks') },
//       { name: 'Algebra', ib: 'https://www.indiabix.com/aptitude/simplification/', yt: yt('algebra+simplification+aptitude+placement') },
//     ],
//   },
//   {
//     title: '🧩 Logical Reasoning', color: '#FFD93D',
//     topics: [
//       { name: 'Number Series', ib: 'https://www.indiabix.com/logical-reasoning/number-series/', yt: yt('number+series+reasoning+tricks') },
//       { name: 'Letter Series', ib: 'https://www.indiabix.com/logical-reasoning/letter-and-symbol-series/', yt: yt('letter+series+reasoning+tricks') },
//       { name: 'Blood Relations', ib: 'https://www.indiabix.com/logical-reasoning/blood-relation/', yt: yt('blood+relations+reasoning+tricks+shortcuts') },
//       { name: 'Coding & Decoding', ib: 'https://www.indiabix.com/logical-reasoning/coding-decoding/', yt: yt('coding+decoding+reasoning+tricks') },
//       { name: 'Direction Sense', ib: 'https://www.indiabix.com/logical-reasoning/direction-sense-test/', yt: yt('direction+sense+reasoning+problems+tricks') },
//       { name: 'Syllogisms', ib: 'https://www.indiabix.com/logical-reasoning/statement-and-argument/', yt: yt('syllogism+reasoning+tricks+placement') },
//       { name: 'Seating Arrangement', ib: 'https://www.indiabix.com/logical-reasoning/seating-arrangement/', yt: yt('seating+arrangement+reasoning+tricks') },
//       { name: 'Puzzles', ib: 'https://www.indiabix.com/logical-reasoning/puzzle/', yt: yt('puzzles+logical+reasoning+placement') },
//       { name: 'Venn Diagrams', ib: 'https://www.indiabix.com/logical-reasoning/venn-diagrams/', yt: yt('venn+diagram+reasoning+problems') },
//       { name: 'Analogies', ib: 'https://www.indiabix.com/logical-reasoning/analogy/', yt: yt('analogy+reasoning+problems+tricks') },
//       { name: 'Order & Ranking', ib: 'https://www.indiabix.com/logical-reasoning/ranking-test/', yt: yt('order+ranking+reasoning+tricks') },
//       { name: 'Statements & Conclusions', ib: 'https://www.indiabix.com/logical-reasoning/statement-and-conclusion/', yt: yt('statements+conclusions+reasoning+placement') },
//       { name: 'Input & Output', ib: 'https://www.indiabix.com/logical-reasoning/machine-input-output/', yt: yt('input+output+reasoning+machine+tricks') },
//       { name: 'Classification', ib: 'https://www.indiabix.com/logical-reasoning/classification/', yt: yt('classification+odd+one+out+reasoning') },
//     ],
//   },
//   {
//     title: '📝 Verbal Ability', color: '#74B9FF',
//     topics: [
//       { name: 'Synonyms & Antonyms', ib: 'https://www.indiabix.com/verbal-ability/synonyms/', yt: yt('synonyms+antonyms+english+placement') },
//       { name: 'Sentence Correction', ib: 'https://www.indiabix.com/verbal-ability/sentence-correction/', yt: yt('sentence+correction+english+grammar+placement') },
//       { name: 'Fill in the Blanks', ib: 'https://www.indiabix.com/verbal-ability/fill-in-the-blanks/', yt: yt('fill+in+the+blanks+english+placement') },
//       { name: 'Reading Comprehension', ib: 'https://www.indiabix.com/verbal-ability/reading-comprehension/', yt: yt('reading+comprehension+tips+tricks+placement') },
//       { name: 'Idioms & Phrases', ib: 'https://www.indiabix.com/verbal-ability/idioms-and-phrases/', yt: yt('idioms+phrases+english+placement') },
//       { name: 'Para Jumbles', ib: 'https://www.indiabix.com/verbal-ability/ordering-of-sentences/', yt: yt('para+jumbles+sentence+rearrangement+english') },
//       { name: 'Error Detection', ib: 'https://www.indiabix.com/verbal-ability/spotting-errors/', yt: yt('error+detection+spotting+errors+english+placement') },
//       { name: 'One Word Substitution', ib: 'https://www.indiabix.com/verbal-ability/one-word-substitutes/', yt: yt('one+word+substitution+english+placement') },
//       { name: 'Active & Passive Voice', ib: 'https://www.indiabix.com/verbal-ability/change-of-voice/', yt: yt('active+passive+voice+english+grammar+tricks') },
//       { name: 'Vocabulary', ib: 'https://www.indiabix.com/verbal-ability/synonyms/', yt: yt('english+vocabulary+placement+preparation') },
//     ],
//   },
// ];
...
const COMPANIES = [
  {
    name: 'TCS', emoji: '🔵', rounds: ['Aptitude Test', 'Technical MCQ', 'Technical Interview', 'HR Interview'],
    gfg: 'https://www.geeksforgeeks.org/tcs-interview-experience/', yt: yt('TCS+placement+preparation+2024')
  },
  {
    name: 'Infosys', emoji: '🟢', rounds: ['InfyTQ Hackathon', 'Reasoning & Verbal', 'Technical Interview', 'HR Interview'],
    gfg: 'https://www.geeksforgeeks.org/infosys-interview-experience/', yt: yt('Infosys+placement+preparation+2024')
  },
  {
    name: 'Wipro', emoji: '🟡', rounds: ['Aptitude', 'Written Communication', 'Technical Interview', 'HR Interview'],
    gfg: 'https://www.geeksforgeeks.org/wipro-interview-experience/', yt: yt('Wipro+WILP+placement+preparation')
  },
  {
    name: 'Cognizant', emoji: '🔷', rounds: ['GAME (Aptitude)', 'Coding Test', 'Technical Interview', 'HR Interview'],
    gfg: 'https://www.geeksforgeeks.org/cognizant-interview-experience/', yt: yt('Cognizant+CTS+placement+preparation')
  },
  {
    name: 'Accenture', emoji: '🟣', rounds: ['Cognitive Test', 'Coding Test', 'Communication Test', 'HR Interview'],
    gfg: 'https://www.geeksforgeeks.org/accenture-interview-experience/', yt: yt('Accenture+placement+preparation+2024')
  },
  {
    name: 'Google', emoji: '🔴', rounds: ['Online Coding', 'Phone Screen', '4-5 Onsite Rounds', 'System Design'],
    gfg: 'https://www.geeksforgeeks.org/google-interview-preparation/', yt: yt('google+software+engineer+interview+preparation+DSA')
  },
  {
    name: 'Amazon', emoji: '🟠', rounds: ['Online Assessment', 'Technical Phone', 'Bar Raiser', 'Leadership Principles'],
    gfg: 'https://www.geeksforgeeks.org/amazon-interview-preparation/', yt: yt('amazon+SDE+interview+preparation+leetcode')
  },
  {
    name: 'Microsoft', emoji: '⬜', rounds: ['Online Coding', '4 Technical Rounds', 'Hiring Manager Round'],
    gfg: 'https://www.geeksforgeeks.org/microsoft-interview-preparation/', yt: yt('microsoft+SDE+interview+preparation+2024')
  },
  {
    name: 'Zoho', emoji: '🌀', rounds: ['Written Test', 'Programming Test', 'Technical Interview', 'HR Interview'],
    gfg: 'https://www.geeksforgeeks.org/zoho-interview-experience/', yt: yt('Zoho+placement+preparation+programming+test')
  },
  {
    name: 'Freshworks', emoji: '💚', rounds: ['Coding Test', 'Technical Interview', 'Hiring Manager', 'HR Interview'],
    gfg: 'https://www.geeksforgeeks.org/freshworks-interview-experience/', yt: yt('Freshworks+interview+preparation+2024')
  },
];
...
function JobsTab({ jobs }) {
  if (!jobs) return (
    <div style={{ textAlign: 'center', padding: 60, color: '#7A7A9D' }}>
      ...
      <div style={{ fontWeight: 700, fontSize: 15 }}>Loading job recommendations...</div>
    </div>
  );
  return (
        ...
        {jobs.recommended_roles.map(r => (
          <div key={r} style={{
            ...
            <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
              ...
              <span style={{ fontWeight: 800, fontSize: 14, color: '#F0F0FF' }}>{r}</span>
            </div>
            <div style={{ display: 'flex', gap: 8 }}>
              <LinkBtn href={`https://www.linkedin.com/jobs/search/?keywords=${encodeURIComponent(r)}`} icon="🔵" label="LinkedIn" color="#0077B5" />
              <LinkBtn href={`https://www.naukri.com/${r.toLowerCase().replace(/\s+/g, '-')}-jobs`} icon="🟠" label="Naukri" color="#FF7555" />
            </div>
          </div>
        ))}
      </div>
...
//   // Stack
//   {
//     topic: 'Stack', name: 'Valid Parentheses',
//     lc: 'https://leetcode.com/problems/valid-parentheses/',
//     gfg: 'https://www.geeksforgeeks.org/check-for-balanced-parentheses-in-an-expression/',
//     hr: 'https://www.hackerrank.com/challenges/balanced-brackets/problem',
...
//   },
//   {
//     topic: 'Stack', name: 'Next Greater Element',
//     lc: 'https://leetcode.com/problems/next-greater-element-i/',
//     gfg: 'https://www.geeksforgeeks.org/next-greater-element/',
//     hr: 'https://www.hackerrank.com/challenges/largest-rectangle/problem',
...
//   // Queue
//   {
//     topic: 'Queue', name: 'Implement Queue using Stacks',
//     lc: 'https://leetcode.com/problems/implement-queue-using-stacks/',
//     gfg: 'https://www.geeksforgeeks.org/queue-using-stacks/',
//     hr: 'https://www.hackerrank.com/challenges/queue-using-two-stacks/problem',
...
//   },
//   {
//     topic: 'Queue', name: 'Design Circular Queue',
//     lc: 'https://leetcode.com/problems/design-circular-queue/',
//     gfg: 'https://www.geeksforgeeks.org/introduction-to-circular-queue/',
//     hr: 'https://www.hackerrank.com/challenges/queue-using-two-stacks/problem',
//     yt: 'https://www.youtube.com/watch?v=aBPEhA0v_vM'
//   },

//   // Recursion
//   {
//     topic: 'Recursion', name: 'Fibonacci Number',
//     lc: 'https://leetcode.com/problems/fibonacci-number/',
//     gfg: 'https://www.geeksforgeeks.org/program-for-nth-fibonacci-number/',
//     hr: 'https://www.hackerrank.com/challenges/ctci-fibonacci-numbers/problem',
//     yt: 'https://www.youtube.com/watch?v=tyB0ztf0DNY'
//   },
//   {
//     topic: 'Recursion', name: 'Subsets',
//     lc: 'https://leetcode.com/problems/subsets/',
//     gfg: 'https://www.geeksforgeeks.org/backtracking-to-find-all-subsets/',
//     hr: 'https://www.hackerrank.com/challenges/crossword-puzzle/problem',
//     yt: 'https://www.youtube.com/watch?v=REOH22XvnEg'
//   },
//   {
//     topic: 'Recursion', name: 'Tower of Hanoi',
//     lc: 'https://leetcode.com/problems/hanota-lcci/',
...
//     yt: 'https://www.youtube.com/watch?v=l45md3RYX7c'
//   },
...
//   const fetchCompletedDSA = async () => {
//     try {
//       const res = await API.get('/placement/completed-dsa');
//       setCompletedDSA(res.data.completed || []);
//     } catch (err) {
//       console.error("Failed to fetch completed DSA problems", err);
//     }
//   };

//   const markDone = async (problemName) => {
//     if (completedDSA.includes(problemName) || marking[problemName]) return;

//     setMarking(prev => ({ ...prev, [problemName]: true }));
//     try {
//       const res = await API.post('/placement/mark-done', { problem_name: problemName });
//       if (res.data.status === 'success') {
//         setCompletedDSA(prev => [...prev, problemName]);
//       }
//     } catch (err) {
//       console.error("Failed to mark problem as done", err);
//     } finally {
//       setMarking(prev => ({ ...prev, [problemName]: false }));
//     }
//   };
...
//                 <span style={{ fontSize: 13, color: '#F0F0FF', fontWeight: 600 }}>Your Progress</span>
//                 <span style={{ fontSize: 13, color: '#FF6584', fontWeight: 800 }}>
//                   {completedDSA.length} / {DSA_PROBLEMS.length} Completed
//                 </span>
//               </div>
//               <div style={{ width: '100%', height: 8, background: 'rgba(255,255,255,0.1)', borderRadius: 10, overflow: 'hidden' }}>
//                 <div style={{
//                   height: '100%',
//                   width: `${(completedDSA.length / DSA_PROBLEMS.length) * 100}%`,
//                   background: 'linear-gradient(90deg, #FF6584, #FFB2C3)',
...
//                   {/* Mark as Done Button */}
//                   <button
//                     onClick={() => markDone(p.name)}
//                     disabled={completedDSA.includes(p.name) || marking[p.name]}
//                     style={{
//                       padding: '5px 12px', borderRadius: 8,
//                       background: completedDSA.includes(p.name) ? '#43E97B22' : 'transparent',
//                       border: `1.5px solid ${completedDSA.includes(p.name) ? '#43E97B' : '#7A7A9D55'}`,
//                       color: completedDSA.includes(p.name) ? '#43E97B' : '#7A7A9D',
//                       fontSize: 12, fontWeight: 800, cursor: completedDSA.includes(p.name) ? 'default' : 'pointer',
//                       transition: 'all 0.15s', whiteSpace: 'nowrap'
//                     }}
//                   >
//                     {marking[p.name] ? 'Wait...' : completedDSA.includes(p.name) ? 'Completed ✅' : 'Mark as Done'}
//                   </button>
//                 </div>
//               </div>
//             ))}
